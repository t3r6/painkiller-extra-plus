...
function MiniGunRL:DrawHUD(delta)
    ...
    if not (INP.IsFireSwitched() or (not Game.SwitchFire[4] and Cfg.SwitchFire[4]) or (not Cfg.SwitchFire[4] and Game.SwitchFire[4])) then
		...
		Hud:DrawDigitsText(w-((118*Cfg.HUDSize)*h/768),((768+Cfg.HUDSize*16)-Cfg.HUDSize*sizey)*h/768,string.sub(string.format("%03d",Player.Ammo.Grenades),-3),0.9 * Cfg.HUDSize,Player.s_SubClass.AmmoWarning.Grenades)
		Hud:DrawDigitsText(w-((118*Cfg.HUDSize)*h/768),((768+Cfg.HUDSize*50)-Cfg.HUDSize*sizey)*h/768,string.sub(string.format("%03d",Player.Ammo.MiniGun),-3),0.9 * Cfg.HUDSize,Player.s_SubClass.AmmoWarning.MiniGun)
	else
		Hud:Quad(self._matAmmoMiniIcon,w-((52*Cfg.HUDSize)*h/768),((768+Cfg.HUDSize*17)-Cfg.HUDSize*sizey)*h/768,Cfg.HUDSize,false)
		Hud:Quad(self._matAmmoRocketIcon,w-((52*Cfg.HUDSize)*h/768),((768+Cfg.HUDSize*49)-Cfg.HUDSize*sizey)*h/768,Cfg.HUDSize,false)
		Hud:DrawDigitsText(w-((118*Cfg.HUDSize)*h/768),((768+Cfg.HUDSize*16)-Cfg.HUDSize*sizey)*h/768,string.sub(string.format("%03d",Player.Ammo.MiniGun),-3),0.9 * Cfg.HUDSize,Player.s_SubClass.AmmoWarning.MiniGun)
		Hud:DrawDigitsText(w-((118*Cfg.HUDSize)*h/768),((768+Cfg.HUDSize*50)-Cfg.HUDSize*sizey)*h/768,string.sub(string.format("%03d",Player.Ammo.Grenades),-3),0.9 * Cfg.HUDSize,Player.s_SubClass.AmmoWarning.Grenades)
	end
end
