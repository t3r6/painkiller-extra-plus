...
Cfg = 
{
  ...
  -- PK++ additions
    ...
    CameraSpeed = 15, -- PK EXP: spectator float/ghost camera speed
    CameraSnap = true, -- PK EXP: snap float/ghost camera to active player
...
--    MBStats = {0,0,0,0,0,12495}, -- (fury,endurance,double haste,blessing,forgiveness)
  ...
  -- HUD / UI / Crosshair
    ...
    HUD_Scores = true,
    HUD_Scores_Frame = 1,
    HUD_Scores_A_Setting = {544,750,0.8},
    HUD_Scores_A_Setting_Save = {0,0,0},
    HUD_Scores_B_Setting = {480,750,0.8},
    ...
    HUD_CurrentWeapon_Icon_Setting = {0,700,1},
...
function Cfg:Check()
  ...
  Cfg.CameraSpeed = Cfg:CheckVar(Cfg.CameraSpeed,"n",0,999,15)
	Cfg.CameraSnap = Cfg:CheckVar(Cfg.CameraSnap,"b")
