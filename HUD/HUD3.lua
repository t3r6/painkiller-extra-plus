...
function Hud:DrawScores(clientid)
  ...
  HUD.DrawQuadRGBA(nil, (1024 - scposxy1[3] - 80 * scsizehud / 2) * w / 1024, (768 - scposxy1[1] - 50 * scsizehud / 2) * h / 768, 80 * scsizehud * w / 1024, 50 * scsizehud * h / 768, cb[1], cb[2], cb[3], 30)
  HUD.DrawQuadRGBA(nil, (1024 - scposxy2[3] - 80 * scsizehud / 2) * w / 1024, (768 - scposxy2[1] - 50 * scsizehud / 2) * h / 768, 80 * scsizehud * w / 1024, 50 * scsizehud * h / 768, cr[1], cr[2], cr[3], 30)
