FavoritesGameMenu =
{
	...
	items =
	{
		...
		AddToFavorites = 
		{
			text = TXT.Menu.RemoveFromFavorites,
			desc = TXT.MenuDesc.RemoveFromFavorites,
			x	 = -1,
			y	 = 80,
			action = "PainMenu:RemoveServerFromFavorites()",
...
--			align = MenuAlign.Center,
		...
		Spectate =
		{
			...
			x	 = 952,
			y	 = 620,
			action = "PainMenu.lastScreen='favorites'; PainMenu:JoinServer( true, true )",
			fontBigSize = 36,
			align = MenuAlign.Right,
			fontBigTex  = "font_texturka_alpha",
			fontSmallTex  = "font_texturka_alpha",
		...
		Join =
		{
			...
			x	 = 952,
			y	 = 660,
			action = "PainMenu.lastScreen='favorites'; PainMenu:JoinServer( true )",
			fontBigSize = 36,
			align = MenuAlign.Right,
			fontBigTex  = "font_texturka_alpha",
			fontSmallTex  = "font_texturka_alpha",
