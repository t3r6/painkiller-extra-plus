		...
		GeneralTab =
		{
			...
			items = 
			{
				...
				GameMode =
				{
					...
					option = "GameMode",
					values = { "Free For All", "Team Deathmatch", "Voosh", "The Light Bearer", "People Can Fly", "Capture The Flag", "Duel", "Last Man Standing", "Clan Arena", "Instagib", "ICTF"}, --  , "Clan Arena"
					visible = { TXT.Menu.FreeForAll, TXT.Menu.TeamDeathmatch, TXT.Menu.Voosh, TXT.Menu.TheLightBearer, TXT.Menu.PeopleCanFly, TXT.Menu.CaptureTheFlag, TXT.Menu.Duel, TXT.Menu.LastManStanding, "Clan Arena", "Instagib FFA", "Instagib CTF"}, -- , "Clan Area"
					x	 = -1,
					y	 = 280,
					action = "",
					align = MenuAlign.Left,
