...
--OriOn_Modification		
		NoAmmoSwitch =
		{
			type = MenuItemTypes.Checkbox,
			text = "No Ammo Switch            ",
			desc = "Switch to another weapon when current weapon is out of ammo",
			option = "NoAmmoSwitch",
			valueOn = true,
			valueOff = false,
			x	 = 70,
