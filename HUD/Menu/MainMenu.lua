...
--			disabled = 1,
		...
		Quit =
		{
			...
			x	 = 15,
			y	 = 640,
			--action = "PainMenu:AskYesNo( Languages.Texts[469], 'Exit()', 'PainMenu:ActivateScreen(MainMenu)' )",                                                  --OriOn_Modification
			action = "PainMenu:QuitConfirmation()",                                                 --OriOn_Modification
--			action = "PainMenu:AskYesNo( Languages.Texts[469], 'PainMenu:ActivateScreen(DemoEnd)', 'PainMenu:ActivateScreen(MainMenu)' )",
			--sndLightOn = "menu/menu/option-light-on_main5",                                                                                                                                                  --OriOn_Modification
		},
		...
		BackButton =
		{
			...
			inGameOnly = 1,
			action = "PMENU.ResumeSounds(); PMENU.ReturnToGame(); PainMenu:ReloadBrightskins(); CONSOLE.SetMPMsgPosition( Hud.mpMsgPosition[1], Cfg.HUD_ConsolePosition )",
			useItemBG = false,
		},
