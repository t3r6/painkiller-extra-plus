...
function Console:Cmd_HUD_AMMOLIST(enable)   
	...
	if(enable=="1")then Cfg.HUD_AmmoList = 1 CONSOLE_AddMessage("AmmoList is now 1, to the right") return end
	if(enable=="2")then Cfg.HUD_AmmoList = 2 CONSOLE_AddMessage("AmmoList is now 2, to the left") return end
	if(enable=="3")then Cfg.HUD_AmmoList = 3 CONSOLE_AddMessage("AmmoList is now 3, to the middle") return end
	CONSOLE_AddMessage("Syntax: HUD_AMMOLIST [0/1/2/3]")
...
function Console:Cmd_FORCE_TEAMS_COLORS(enable)    
	if(enable=="1")then Cfg.FixedColors = false CONSOLE_AddMessage("FixedColors is now enabled") Game:ReloadBrightskins() return end
	if(enable=="0")then Cfg.FixedColors = true CONSOLE_AddMessage("FixedColors is now disabled") Game:ReloadBrightskins() return end
	CONSOLE_AddMessage("Syntax: FixedColors [1/0]")
	CONSOLE_AddMessage("Help: Switches colours.")
	if not Cfg.FixedColors then CONSOLE_AddMessage("State: FixedColors is currently on.")
	else CONSOLE_AddMessage("State: FixedColors is currently off.") end
end
--=======================================================================
function Console:Cmd_BRIGHTSKINS(enable)    
	if(enable=="1")then Cfg.BrightSkins = true CONSOLE_AddMessage("BrightSkins is now enabled. Requires restart.") PainMenu:ReloadBrightskins() return end
	if(enable=="0")then Cfg.BrightSkins = false CONSOLE_AddMessage("BrightSkins is now disabled. Requires restart.") PainMenu:ReloadBrightskins() return end
...
function Console:Cmd_BRIGHTSKINENEMY(enable)  
	...
	if(enable=="Purple" or enable=="purple")then Cfg.BrightskinEnemy="Purple" CONSOLE_AddMessage("Colours changed") Game:ReloadBrightskins() return end
	if(enable=="Grey" or enable=="grey")then Cfg.BrightskinEnemy="Grey" CONSOLE_AddMessage("Colours changed") Game:ReloadBrightskins() return end
	if(enable=="Brown" or enable=="brown")then Cfg.BrightskinEnemy="Brown" CONSOLE_AddMessage("Colours changed") Game:ReloadBrightskins() return end

	CONSOLE_AddMessage("Syntax: BrightskinEnemy [Red/Green/Blue/Cyan/Magenta/Yellow/White/Black/Orange/Pink/Purple/Grey/Brown]")
...
function Console:Cmd_BRIGHTSKINTEAM(enable)  
	...
	if(enable=="Purple" or enable=="purple")then Cfg.BrightskinTeam="Purple" CONSOLE_AddMessage("Colours changed") Game:ReloadBrightskins() return end
	if(enable=="Grey" or enable=="grey")then Cfg.BrightskinTeam="Grey" CONSOLE_AddMessage("Colours changed") Game:ReloadBrightskins() return end
	if(enable=="Brown" or enable=="brown")then Cfg.BrightskinTeam="Brown" CONSOLE_AddMessage("Colours changed") Game:ReloadBrightskins() return end
...
function Console:Cmd_EXAMPLECONFIG()
  -- Create any Cfg parameter list you want to execute
	...
	CONSOLE_AddMessage("Example config executed.")
end
--=======================================================================
...
function Console:Cmd_PCFWEAPONS(enable)
	...
	else CONSOLE_AddMessage("State: PCFWeapons is disabled.") end
end
--=======================================================================
